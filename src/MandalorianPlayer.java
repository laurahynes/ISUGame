...
//need to add lazers hitting the player, losing health
public class MandalorianPlayer extends Players {            
     Animation ani[] = new Animation[4];
         
     
     Image walk[][] = new Image[4][3];
    ...
    public MandalorianPlayer(int x, int y) throws SlickException {
        super(x, y);
