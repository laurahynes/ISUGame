...
public class Level1 extends BasicGameState {
    ...
    //sets shooting to false at start of level
    ...
    public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
       mainImg = new Image("images/Level Backgrounds/Level 1.png");      
       ...
       //set lazers x and y to players x and y
       mx = player1.getX();
       my = player1.getY();
    ...
    public void update(GameContainer gc, StateBasedGame sbg, int i) throws SlickException { 
        ...
        //checking to see if shooting (can only shoot one at a time), setting lazer x and y to player x and y, making shooting true
        //enter to shoot
        ...
        //reads direction to see which image to use for lazer, and which x and y to go towards
        if(isMandShooting){
        ...
        //when a player dies, add win for player that won and go to next level
    ...
    public void render(GameContainer gc, StateBasedGame sbg, Graphics g) throws SlickException {
       ...
       //only draw lazers if the player is shooting
      if(isMandShooting){         
            ml.draw();            
      }
